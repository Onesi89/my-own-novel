...
export function QuickActionsGrid({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={onCreateNewStory}>
      ...
      <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={onViewMyStories}>
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
